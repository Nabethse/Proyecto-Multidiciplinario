...
public class InicioController {
    ...
    void onClickIniciarSecion(MouseEvent event) {
        HelloApplication.newStage("inicioSesion-view","SECION");
    }

    @FXML
    void onClickRegistrarse(MouseEvent event) {
        HelloApplication.newStage("registrarse-view", "REGISTRARSE");
    }
    ...
    void initialize() {
        ...
        assert Registrarse != null : "fx:id=\"Registrarse\" was not injected: check your FXML file 'inicio-view.fxml'.";
