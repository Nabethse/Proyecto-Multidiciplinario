...
public class Casos {
    ...
    // Lista para almacenar los casos (estática para ser compartida entre todas las instancias de Casos)
    ...
    // Método para guardar un caso en la lista de casos
    public boolean save() {
        return casosList.add(this);
    }

    // Método para obtener la lista de casos (debe ser estático)
